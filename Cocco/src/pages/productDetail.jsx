...
function ProductDetail() {
    const {id} = useParams();
    const {products, quantity, isLoading} = useProductContext();
                    ...
                    isLoading ? (
                        Array.from({length: 1}).map((_, index) => (
                            <div key={index} className="d-flex gap-5">
                                <Skeleton variant='rounded' width={500}
                                ...
                                <div className=''>
                                    ...
                                    <div className='d-flex align-items-center gap-3'>
                                        <Skeleton variant='text' width={180} height={120}/>
                                        <Skeleton variant='text' width={170} height={120}/>
                                    </div>
                                    <div className=''>
                                                ...
                                                <div className="tab-pane fade" id="profile" role="tabpanel"
                                                    ...
                                                    <div className='d-flex align-items-center gap-2'>
                                                        ...
                                                        <p style={{color: 'gray', fontSize: '14px'}}
                                                           className='d-flex align-items-center gap-1'>{product.dimensions.length}
